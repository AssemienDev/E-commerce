...
@WebServlet(name = "oRdinateur", value = "/ordinateur")
public class Ordinateur extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD)) {
            ...
            String sqlProduits = "SELECT * FROM PRODUITS WHERE NOMCATEGORIE ='ordinateur' ";
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("Ordinateur.jsp");
