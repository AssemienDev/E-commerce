...
@WebServlet(name = "eCran", value = "/ecran")
public class Ecran extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD)) {
            ...
            String sqlProduits = "SELECT * FROM PRODUITS WHERE NOMCATEGORIE ='ecran'";
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("Ecran.jsp");
