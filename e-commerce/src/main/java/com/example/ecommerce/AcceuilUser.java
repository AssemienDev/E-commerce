...
@WebServlet(name = "acceuilUser", value = "/acceuil-user")
public class AcceuilUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD)) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("AcceuilProduitUser.jsp");
