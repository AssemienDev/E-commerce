...
@WebServlet(name = "casquesSouris", value = "/casques-souris")
public class CasquesSouris extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD)) {
            ...
            String sqlProduits = "SELECT * FROM PRODUITS WHERE NOMCATEGORIE IN ('casque','souris')";
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("Casques&souris.jsp");
