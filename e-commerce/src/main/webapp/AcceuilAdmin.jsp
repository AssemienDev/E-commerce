        ...
        <div class="barre bg-light my-2">
            <div class="row">
                <div class="col-3 actif element text-center">
                    <a href="hello-servlet" style="color: white;">UTILISATEUR</a>
                </div>
...
<div class="principale">
    <h2  style="color: white;" class="mx-5 my-3">Liste des clients inscrits</h2>
    <div class="container table-responsive my-4" style="width: 100%;">
        <table class="table">
            ...
            <tbody>
            <% List<Map<String, String>> listeClients = (List<Map<String, String>>) request.getAttribute("listeClients");
            ...
            <tr>
                ...
                <td><%= client.get("mot_secret") %></td>
            </tr>
            <%}} else { %>
            <p style="font-size: xx-large; color: white">Aucun client.</p>
            <% } %>
            </tbody>
        </table>
    </div>
