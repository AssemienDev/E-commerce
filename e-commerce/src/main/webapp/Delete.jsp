...
<div class="principale">
    <h3 style="color: white; margin-top: 2%; margin-left: 5%;"><a href="produit-admin" style="color: #EE4900;">PRODUITS</a>/<a  style="color: silver;">DELETE PRODUIT</a></h3>
    <div class="container box-inscription" style="color: white;">
        <%
            String reponse = (String) request.getAttribute("reponse");
            if (reponse == "Prduit Supprimer") {
        %>
        <p class="fw-bold text-center my-5"  style="color: dodgerblue; font-size: xx-large;"><%= reponse %></p>
        <%}else if (reponse == "Prduit Non Supprimer"){%>
