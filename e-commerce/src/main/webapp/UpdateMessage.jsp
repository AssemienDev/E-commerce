...
<div class="principale">
    <h3 style="color: white; margin-top: 2%; margin-left: 5%;"><a href="produit-admin" style="color: #EE4900;">PRODUITS</a>/<a  style="color: silver;">UPDATE PRODUIT</a>/<a  style="color: silver;">UPDATE PRODUIT MESSAGE</a></h3>
    <div class="container box-inscription" style="color: white;">
        <%
            String valide = (String) request.getAttribute("valide");
            if (valide == "Enregistrement Validé") {
        %>
        <p class="fw-bold text-center my-5" style="color: dodgerblue; font-size: x-large;"><%= valide %></p>
        <%}else if (valide == "Enregistrement Non Validé"){ %>
        <p class="fw-bold text-center my-5" style="color: red; font-size: x-large;"><%= valide %></p>
        <%}else if (valide == "Erreur de saisie dans le prix"){ %>
        <p class="fw-bold text-center my-5" style="color: red; font-size: x-large;"><%= valide %></p>
        <%}%>
