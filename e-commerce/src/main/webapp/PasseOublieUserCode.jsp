...
<head>
    ...
    <title>Passe Oublier Valider</title>
...
<div class="form">
    <form class="text-center container">
        <h2 class="text-center">MOTS DE PASSE</h2>

        <%
            String erreur2 = (String) request.getAttribute("resultat2");
            if (erreur2 != null) {
        %>
        <p class="text-center y-1" style="font-size: x-large"><%= erreur2 %></p>
        <%
            }
        %>

        <%
            String erreur1 = (String) request.getAttribute("resultat1");
            if (erreur1 != null) {
        %>
        <p class="text-center y-4" style="font-size: x-large">Passe: <%= erreur1 %></p>
        <%
            }
        %>
